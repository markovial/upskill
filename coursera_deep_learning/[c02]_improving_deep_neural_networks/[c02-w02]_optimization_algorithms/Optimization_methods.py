...
def random_mini_batches(X, Y, mini_batch_size = 64, seed = 0):
    ...
    for k in range(0, num_complete_minibatches):
        ...
        # 0   -> 64  : mini*0 : mini*1
        # 64  -> 128 : mini*1 : mini*2
        # 128 -> 192 : mini*2 : mini*3
        start = (k)   * mini_batch_size
        stop  = (k+1) * mini_batch_size
        mini_batch_X = shuffled_X[:,  start : stop ]
        mini_batch_Y = shuffled_Y[:,  start : stop ]
    ...
    if m % mini_batch_size != 0:
        ...
        # mini_batch_Y =
        # YOUR CODE STARTS HERE
        start = mini_batch_size * num_complete_minibatches
        stop  = start + m % mini_batch_size
        mini_batch_X = shuffled_X[:,  start : stop ]
        mini_batch_Y = shuffled_Y[:,  start : stop ]        
        # YOUR CODE ENDS HERE
        mini_batch = (mini_batch_X, mini_batch_Y)
...
def schedule_lr_decay(learning_rate0, epoch_num, decay_rate, time_interval=1000):
    ...
    learning_rate = learning_rate0 * (1/(1+(decay_rate*math.floor( epoch_num / time_interval ))))
