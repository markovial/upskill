...
def music_inference_model(LSTM_cell, densor, Ty=100):
    ...
    for t in range(Ty):
        ...
        # next_hidden_state, _, next_cell_state
        # = LSTM_cell(input_x, initial_state=[previous_hidden_state, previous_cell_state])
        a, _, c = LSTM_cell(inputs = x, initial_state=[a, c])
    ...
    # Model(inputs=[input_x, initial_hidden_state, initial_cell_state], outputs=the_outputs)
